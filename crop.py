...
def main():
    st.markdown(
        ...
        section[data-testid="stSidebar"] {
         ...
         .stButton > button {
            background: linear-gradient(to right,#CEF576,#84FB95);
            color: black;
            border: none;
            padding: 0.5em 2em;
            border-radius: 10px;
        ...
        .stButton > button:hover {
            background: linear-gradient(to right,#1A512E , #63A91F );
            color: white;
        }
        </style>
        """,
    ...
    html_temp_vis = """
    <div style="background: linear-gradient(to right, #1A512E , #63A91F) ;padding:10px;margin-bottom:30px">
